...
?>
<?
if($arCurSection["UF_SECTION_TEXT"])
{
	echo $arCurSection["UF_SECTION_TEXT"];
}
if($arCurSection["UF_SHOW_H1"])
{
	$APPLICATION->SetPageProperty("h1", $arCurSection["UF_SHOW_H1"]);
}
?>
<?if (false && strlen($arCurSection["DESCRIPTION"])>0 && $arParams["SHOW_DESCRIPTION_AFTER_SECTION"] != "Y"){?>
...
<div class="container full-width">
	...
	<?if (strlen($arCurSection["DESCRIPTION"])>0 && $arParams["SHOW_DESCRIPTION_AFTER_SECTION"] != "N"){?>
		<div class="container full-width">
			<div class="row">
					<div class="col-lg-12">
						<div class="section-description">

...
/*if (file_exists($_SERVER["DOCUMENT_ROOT"]."/local/components/alexkova.corporate/element.draw/lang/".LANGUAGE_ID."/default_lang.php"))
	include_once($_SERVER["DOCUMENT_ROOT"]."/local/components/alexkova.corporate/element.draw/lang/".LANGUAGE_ID."/default_lang.php");
else
	require_once($_SERVER["DOCUMENT_ROOT"]."/bitrix/components/alexkova.corporate/element.draw/lang/".LANGUAGE_ID."/default_lang.php");*/
...
$arComponentParameters = array(
	"GROUPS" => array(
		"ELEMENT_MODE"=>array("NAME"=>GetMessage("ELEMENT_MODE_DESC"))
	),
	"PARAMETERS" => array(
		"AJAX_MODE" => array(),
		"IBLOCK_TYPE" => array(
		...
		"PAGE_BLOCK_TITLE_GLYPHICON" => array(
			"PARENT" => "ELEMENT_MODE",

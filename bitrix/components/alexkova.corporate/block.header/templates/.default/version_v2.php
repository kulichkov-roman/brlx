...
<?$APPLICATION->IncludeComponent("alexkova.corporate:abmanager", $BannerTemplate, array(
	...
	<div class="dcontainer dark-light theme2 border-light <?=$addHeaderClass?>  head-container" <?=$addHeaderStyle?>">


		<div class="container">

			<div class="row headline2">
				<div class="col-lg-8 col-md-8 hidden-xs hidden-sm tb10">
					<?$APPLICATION->IncludeComponent(
						...
						Array(
							...
							"EDIT_TEMPLATE" => "",
							"PATH" => SITE_DIR."include/headline.php",
							"INCLUDE_PTITLE"=>GetMessage('HEADLINE_AREA')
						),
						$component
					);?>
				</div>
				<div class="col-lg-4 col-md-4 hidden-sm hidden-xs">
					<div id="search-line" class="mini">
						<?$APPLICATION->IncludeComponent(
							"bitrix:search.form",
							"corporate_search",
							Array(
		...
		<div class="row">
			...
			<div class="col-lg-9 col-md-9 hidden-xs hidden-sm <?=$arAddClasses[$arResult["PARAMS"]["DISPLAY_MENU_VARIANT"]]?>">
				<?
				global $compoundMenu;
				$compoundMenu = true;

				if (file_exists(dirname(__FILE__)."/".$arResult["PARAMS"]["DISPLAY_MENU_VARIANT"]."2.php"))
					include($arResult["PARAMS"]["DISPLAY_MENU_VARIANT"]."2.php");
				?>
			</div>

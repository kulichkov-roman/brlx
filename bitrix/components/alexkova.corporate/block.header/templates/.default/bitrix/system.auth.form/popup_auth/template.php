...
<div class="login_page action-form-t">
	...
	<form name="system_auth_form<?=$arResult["RND"]?>" method="post" target="_top" action="<?=SITE_DIR?>auth/<?//=$arResult["AUTH_URL"]?>" class="bx_auth_form">
		...
		<input placeholder="<?=GetMessage('AUTH_LOGIN_FIELD');?>" class="form-control" type="text" name="USER_LOGIN" maxlength="255" value="<?=$arResult["LAST_LOGIN"]?>" />
		<input placeholder="<?=GetMessage("AUTH_PASSWORD");?>" class="form-control" type="password" name="USER_PASSWORD" maxlength="255" />

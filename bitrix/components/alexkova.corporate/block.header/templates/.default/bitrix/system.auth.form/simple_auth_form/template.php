...
?>
	<a href="<?=$arResult["AUTH_URL"]?>" class="signin" onclick='var modalH = $(".loginform").height(),modalW = $(".loginform").width(); $(".loginform").css({"display":"block","margin-top":"-"+(parseInt(modalH)/2)+"px","margin-left":"-"+(parseInt(modalW)/2)+"px" }); return false;'><?=GetMessage("AUTH_LOGIN")?></a>
<?

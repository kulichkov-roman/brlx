                            ...
                            <? endif;?>
                                ...
                                <?foreach ($item["PROPERTIES"]["LINK"]["VALUE"] as $k => $link):?>
                                    <div class="modern-card-buttons">
                                        <?if ($item["PROPERTIES"]["SLIDER_LINK"]["VALUE"] != "Y"):?>
                                            <a href="<?=$link;?>" class="button-heder2-slider color-button small-button open-answer-form"><?=$item["PROPERTIES"]["LINK"]["DESCRIPTION"][$k];?></a>
                                        <?else:?>
                                            <span class="button-heder2-slider color-button small-button open-answer-form"><?=$item["PROPERTIES"]["LINK"]["DESCRIPTION"][$k];?></span>
                                        <? endif;?>
                                    </div>
                                <?endforeach;?>
                            </div>
